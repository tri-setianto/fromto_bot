...
public class ConfigUser extends TableImpl<ConfigUserRecord> {
    ...
    private static final long serialVersionUID = -152338969;
     ...
     */
    public final TableField<ConfigUserRecord, String> LANG_SOURCE = createField("lang_source", org.jooq.impl.SQLDataType.VARCHAR.length(3).defaultValue(org.jooq.impl.DSL.inline("en", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>transbot.config_user.lang_target</code>.
     */
    public final TableField<ConfigUserRecord, String> LANG_TARGET = createField("lang_target", org.jooq.impl.SQLDataType.VARCHAR.length(3).defaultValue(org.jooq.impl.DSL.inline("id", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
